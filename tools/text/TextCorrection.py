#%%
# 讯飞开放平台
# https://www.xfyun.cn/services/textCorrection?target=price
# -*- coding:utf-8 -*-
...
if __name__ == '__main__':
    #控制台获取
    APPId = "fe54c86f"
    APISecret = "YmQwMzhmMjMwYzAyZDY2NDY1N2U3NzRj"
    APIKey = "7dfe813124f0eade537bdd4b27a12142"


    data = pandas.read_excel("E:\\PyTools\\dragon\\tools\\text\\Text.xlsx")
    data_v = data.values
    for m in range(1,len(data_v)):
