...
# # 单发
# rewards = [[[1002,100000000]]]
# template_list = [316,317,318,414,415]
# for i in template_list:
#     rewards.append([[i*1000+1,10]])
...
for reward in rewards:
    mails(pid_list,mail_title,mail_content,reward,server)
