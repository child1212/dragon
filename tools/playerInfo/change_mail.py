...
accounts = {"li2022"}
# 等级
# param["growthFund"] = '{"@class":"com.game.mongo.model.PlayerGrowthFund","shopId":null,"rewardIds":["java.util.ArrayList",[]],"shopIds":["java.util.ArrayList",["25"]]}'
# # 等级
# param["level"] = 30
# 昵称
# param["nickName"] = "gold"
...
for account in accounts:
    ...
    change_Param(prop,log_res,server,mail)
